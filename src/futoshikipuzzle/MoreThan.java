...
public class MoreThan extends Constraint {    
    ...
    /**
     * Constructor for the MoreThan class, sets the square variables for the
     * super class
     * 
     * @param square1 the left or above square
     * @param square2 the right or below square
     */
    public MoreThan(FutoshikiSquare square1, FutoshikiSquare square2) {
     ...
     * 
     * @return boolean if valid returns true if square one is more than square two
     */
    @Override
